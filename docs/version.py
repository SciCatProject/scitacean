...
def _get_releases(repo: str, organization: str = "SciCatProject") -> List[Version]:
...
class VersionInfo:
    def __init__(self, repo: str, organization: str = "SciCatProject"):
        self._releases = _get_releases(repo=repo, organization=organization)
        if not self._releases:
            self._releases = [Version("0.0.0")]
